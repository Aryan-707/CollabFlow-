...
const TaskTable: React.FC<TaskTableProps> = ({
  ...
  const getStorageKey = () => {
    if (projectSlug) {
      return `CollabFlow_task_table_column_order_${projectSlug}`;
    } else if (workspaceSlug) {
      return `CollabFlow_task_table_column_order_workspace_${workspaceSlug}`;
    } else {
      return 'CollabFlow_task_table_column_order_global';
    }
  };
