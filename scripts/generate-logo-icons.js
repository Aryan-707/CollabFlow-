 ...
 *
 * Options:
 *   --source   Source SVG file path (default: assets/logo/CollabFlow-logo.svg)
...
const DEFAULT_SOURCE = path.join(ROOT_DIR, 'assets/logo/CollabFlow-logo.svg');
...
const ICON_SIZES = [
  ...
  { name: 'CollabFlow-logo.png', size: 512, description: 'CollabFlow Logo' },
];
